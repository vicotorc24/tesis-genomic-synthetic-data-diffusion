...
# Configuración del Arsenal Moderno
MODERN_CLASSIFIERS = {
    ...
    'TabPFN': TabPFNClassifier(n_estimators=32, device='auto', ignore_pretraining_limits=True),
...
if __name__ == "__main__":
    ...
    path_synth = 'results/synthetic_samples_optimal_5000.parquet'
    ...
    if all_modern_results:
        ...
        output_path = 'results/metrics/MODERN_BENCHMARK_RESULTS_2026.csv'
